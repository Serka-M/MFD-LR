...
ggsave(plot_ag, file="../analysis/figures/FigS13.png", height=180, width=180,  units="mm", dpi=450)
```
...
#ggsave(plot_otus, file="../analysis/figures/FigS14.png", height = 180, width = 160,  units ="mm", dpi = 450)
```
