...
#ggsave(file="../analysis/figures/FigS1.png", height = 180, width = 150,  units ="mm", dpi = 450)
```
...
plot_drep_n <- ggplot(data=mags_drep_n2, aes(x=factor(id,level=rev(id)), y=drep_cluster_n, color=phylum)) + 
               labs(title="", y="MAGs per cluster", x="Genus (GTDB) and species cluster", color="Phyla:") + 
               ...
               preset_gen2 + theme(legend.position = "right") + 
