...
#ggsave(file="../analysis/figures/FigS1.png", height = 200, width = 160,  units ="mm", dpi = 450)
```
...
#ggsave(file="../analysis/figures/FigS3.png", height = 150, width = 180,  units ="mm", dpi = 450)
```
...
#ggsave(file="../analysis/figures/FigS6.png", height = 200, width = 180,  units ="mm", dpi = 450)
```
...
#ggsave(drep_rf_hab_plot3, file="../analysis/figures/FigS7.png", height = 120, width = 140, units ="mm", dpi = 450)
```
...
ggsave(file="../analysis/figures/FigS8.png", height = 180, width = 160,  units ="mm", dpi = 450)
```
...
#ggsave(drep_rf_phyl_plot2, file="../analysis/figures/FigS15.png", height = 145, width = 140, units ="mm", dpi = 450)
```
...
#ggsave(file="../analysis/figures/FigS16.png", height = 180, width = 140,  units ="mm", dpi = 450)
```
