...
#ggsave(plots_core_hab, file="../analysis/figures/FigS9.png", height = 90, width = 180,  units ="mm", dpi = 450)
```
...
#ggsave(fig_sylph_hab, file="../analysis/figures/FigS10.png", height = 180, width = 200,  units ="mm", dpi = 450)
```
...
#ggsave(plot_af, file="../analysis/figures/FigS5.png", height = 200, width = 180, units ="mm", dpi = 450)
```
