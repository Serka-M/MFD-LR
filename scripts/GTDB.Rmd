...
plot_tree <- ggtree(gtdb_tree, layout="circular", aes(color=group), lwd=0.05) %<+% label_phyla +
             ...
             guides(color = guide_legend(order=1, ncol=2, title="Domain", override.aes = list(shape=NA, linewidth=2)), fill=none) + new_scale_fill() + 
...
ggsave(plot_tree2, file="../analysis/figures/FigS12.pdf", height = 8, width = 12, useDingbats=FALSE)
```
