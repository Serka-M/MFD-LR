...
#ggsave(plot_cov, file="../analysis/figures/FigS17.png", height = 240, width = 180, units ="mm", dpi = 450)
```
...
#ggsave(plot_tree2, file="../analysis/figures/FigS11.png", height = 120, width = 180, units ="mm", dpi = 450)
```
