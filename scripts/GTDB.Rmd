...
### Plot tree
```{r, include=TRUE}
tree_gtdb <- ggtree(gtdb_tree, layout="circular", aes(color=group), lwd=0.05) %<+% label_phyla +
...
ggsave(tree_gtdb, file="../analysis/figures/Fig4.pdf", height = 8, width = 12, useDingbats=FALSE)
```
